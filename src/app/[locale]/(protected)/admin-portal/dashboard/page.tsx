    ...
    return (
        ...
        >
            ...
            <motion.div variants={item} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <QuickActionButton 
                    label="Go to Employer Portal" 
                    icon={IconBuildingSkyscraper} 
                    href="/employer-portal/dashboard"
                    description="Switch to employer view"
                    variant="primary"
                />
                <QuickActionButton 
                    label="Audit Logs" 
                    ...
                    <Card className="rounded-[3rem] border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50 p-2 overflow-hidden h-full">
                        <CardHeader className="p-8 pb-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Button variant="ghost" size="sm" asChild className="rounded-xl font-black text-[10px] uppercase tracking-widest text-primary hover:bg-primary/5">
                                    <Link href="/admin-portal/audit-logs">
                                        Full Logs <IconChevronRight className="h-3 w-3 ml-1" />
                                    </Link>
                                </Button>
                            </div>
                        </CardHeader>
                        <CardContent className="p-8 pt-4">
                            <div className="space-y-6">
                                {stats?.recentActivity?.length === 0 ? (
                                    ...
                                    stats?.recentActivity?.slice(0, 8).map((act: any) => (
