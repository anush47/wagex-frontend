...
export const EpfTab = () => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                    ...
                    {epfRecordsQuery.isLoading ? (
                        ...
                        <div className="p-32 flex flex-col items-center justify-center text-center gap-6 bg-neutral-50/20 dark:bg-transparent">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[11px] font-medium text-neutral-400 max-w-[240px]">Access your EPF history by generating a new report or adjusting filters.</p>
                            </div>
                        </div>
                    ) : (
            ...
            <GenerateEpfDialog open={isGenerateOpen} onOpenChange={setIsGenerateOpen} companyId={companyId} />
            <EpfDetailsDialog 
                open={!!selectedRecord}
