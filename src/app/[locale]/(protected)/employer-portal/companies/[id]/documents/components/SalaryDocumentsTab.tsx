...
import { IconDownload, IconFileSpreadsheet, IconSearch, IconCalendar } from "@tabler/icons-react";
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-2 max-w-md w-full">
                    <div className="relative w-full">
                        ...
                        <Input placeholder="Search salary months..." className="pl-9 h-11 rounded-xl" />
                    </div>
                </div>
            ...
            <Card className="rounded-2xl border-none bg-neutral-50 dark:bg-neutral-900 shadow-none overflow-hidden">
                ...
                <CardContent className="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <h3 className="font-bold text-lg">No Monthly Data Selected</h3>
                    <p className="text-neutral-500 text-sm max-w-xs mx-auto mt-2 font-medium">
                        Select a specific month and year from the filters above to generate sheets.
                    </p>
                </CardContent>
            </Card>
        </div>
