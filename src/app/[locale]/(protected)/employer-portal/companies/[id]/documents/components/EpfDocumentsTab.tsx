...
import { IconDownload, IconReceiptTax, IconSearch, IconFilter, IconX, IconRefresh } from "@tabler/icons-react";
...
export function EpfDocumentsTab() {
    ...
    // Derived month/year from startDate for StatutorySelectionTable if needed,
    // though StatutorySelectionTable currently takes month/year.
    // We'll pass them if available.
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 pb-20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
                <div className="space-y-1.5">
                    <h3 className="text-xl font-black tracking-tight uppercase text-foreground/90 italic">EPF Form C Reports</h3>
                    <p className="text-neutral-500 font-medium text-xs">Generate and download official EPF C and C3 schedules</p>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    >
                        ...
                        Download Forms {selectedBatchIds.length > 0 ? `(${selectedBatchIds.length})` : ''}
                    </Button>
                </div>
            </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">Select calculated EPF batches for compliance</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="lg:col-span-4 space-y-6 sticky top-6">
                    <Card className="border-2 border-neutral-100 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-950/20 rounded-[2.5rem] p-8 space-y-8 shadow-inner">
                        ...
                        <div className="pt-4 space-y-4">
                            <div className="p-6 rounded-3xl bg-amber-500 text-white shadow-2xl shadow-amber-500/20 flex flex-col gap-2 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:scale-125 transition-transform duration-500">
                                    <IconReceiptTax className="h-16 w-16" />
                                </div>
                                <span className="text-[10px] font-black uppercase text-white/70 tracking-widest italic relative z-10">Export Compliance</span>
                                ...
                                <Button 
                                    className={cn(
                                        ...
                                        selectedBatchIds.length > 0 ? "bg-white text-amber-500 hover:bg-neutral-50" : "bg-white/50 text-amber-500/50 cursor-not-allowed"
                                    )}
                                    disabled={selectedBatchIds.length === 0}
                                >
                                    Generate Form C
                            ...
                            <p className="text-[10px] font-bold text-neutral-400 text-center uppercase tracking-widest italic px-1 leading-relaxed">
                                Form C generation requires finalized payroll records.
                            </p>
                        </div>
                    </Card>
                </div>
