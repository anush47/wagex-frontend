        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
                <div className="space-y-1.5">
                    <h3 className="text-xl font-black tracking-tight uppercase text-foreground/90">EPF Form C Reports</h3>
            ...
            {showFilters && (
                <Card className="border-2 border-dashed border-neutral-100 dark:border-neutral-800 bg-neutral-50/30 dark:bg-neutral-950/20 rounded-[2rem] p-8 animate-in slide-in-from-top-4 duration-300 shadow-inner">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black uppercase text-neutral-400 tracking-[0.2em] pl-1">Search Filings</Label>
                ...
                <CardContent className="p-0">
                    <div className="flex flex-col items-center justify-center py-32 text-center gap-8">
                        <div className="relative">
                            <div className="h-24 w-24 rounded-[2.5rem] bg-amber-500/5 flex items-center justify-center animate-pulse">
                                <IconReceiptTax className="h-10 w-10 text-amber-500/20" />
                            </div>
                            <div className="absolute -bottom-2 -right-2 h-10 w-10 rounded-2xl bg-white dark:bg-neutral-800 shadow-xl flex items-center justify-center border border-neutral-100 dark:border-neutral-700">
                                <IconDownload className="h-5 w-5 text-amber-500" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-neutral-400 text-xs max-w-[280px] mx-auto font-bold uppercase tracking-widest leading-relaxed">
                                Please ensure salary calculations for {monthsNames[month - 1]} {year} are completed before generating EPF forms.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-4">
                            <Button 
                                ...
                                disabled
                            >
                                <IconRefresh className="mr-3 h-5 w-5 stroke-[3]" />
                                Re-sync Payroll
                            </Button>
                        </div>
                    </div>
