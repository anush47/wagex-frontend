        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-2 max-w-md w-full">
                    <div className="relative w-full">
                        ...
                        <Input placeholder="Search ETF filings..." className="pl-9 h-11 rounded-xl" />
                    </div>
                </div>
            ...
            <Card className="rounded-2xl border-none bg-neutral-50 dark:bg-neutral-900 shadow-none overflow-hidden">
                <CardHeader className="bg-white dark:bg-neutral-800 border-b border-neutral-100 dark:border-neutral-700/50 px-6 py-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle className="text-lg font-bold">ETF Reports</CardTitle>
                                <p className="text-xs text-neutral-500 font-medium">Generate ETF contribution schedules for the central bank</p>
                            </div>
                        </div>
                ...
                <CardContent className="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <h3 className="font-bold text-lg">ETF Data Unavailable</h3>
                    <p className="text-neutral-500 text-sm max-w-xs mx-auto mt-2 font-medium">
                        Search results will appear here once the month is processed.
                    </p>
                </CardContent>
            </Card>
        </div>
