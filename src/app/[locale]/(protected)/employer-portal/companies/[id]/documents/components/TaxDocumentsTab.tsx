...
import { IconDownload, IconGraph, IconSearch, IconAdjustments } from "@tabler/icons-react";
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-2 max-w-md w-full">
                    <div className="relative w-full">
                        ...
                        <Input placeholder="Search tax records..." className="pl-9 h-11 rounded-xl" />
                    </div>
                </div>
            ...
            <Card className="rounded-2xl border-none bg-neutral-50 dark:bg-neutral-900 shadow-none overflow-hidden">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center">
                                <IconGraph className="h-5 w-5 text-primary" />
                            </div>
                            <div>
                                <CardTitle className="text-lg font-bold">Tax Compliance Reports</CardTitle>
                                <p className="text-xs text-neutral-500 font-medium">Export APIT and other tax deduction certificates</p>
                            </div>
                        </div>
                ...
                <CardContent className="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <h3 className="font-bold text-lg">No Tax Records Found</h3>
                    <p className="text-neutral-500 text-sm max-w-xs mx-auto mt-2 font-medium">
                        Search or filter for a specific tax year to generate records.
                    </p>
                </CardContent>
            </Card>
        </div>
